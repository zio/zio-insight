package zio.insights.frontend.utils
...
object DomUtils {
  ...
  /**
   * Taken from
   * https://github.com/scala-js/scala-js-dom/blob/series%2F1.x/src/main/scala/org/scalajs/dom/ext/Extensions.scala This
   * `Color` class has been dropped since scalajs-dom 2.0.
   *
